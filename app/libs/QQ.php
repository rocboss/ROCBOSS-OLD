...
class Recorder
{
    ...
    private $inc;
    private $error;
    public function __construct($appid = "", $appkey = "", $callback_url)
    {
...
class Oauth
{
    ...
    public $urlUtils;
    protected $error;
    function __construct($appid, $appkey, $callback_url)
    {
        $this->recorder = new Recorder($appid, $appkey, $callback_url);
...
class QQ extends Oauth
{
    ...
    public function __construct($appid, $appkey, $callback_url = "/", $access_token = "", $openid = "")
    {
        parent::__construct($appid, $appkey, $callback_url);
