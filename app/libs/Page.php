...
class Page
{
    ...
    public function up_page($name = '上一页')
    {
        if ($this->now_page != 1)
        {
            return $this->_get_link($this->now_page - 1, $name, 'class="btn btn-inverse previous"');
        }
        return '';
    }
    ...
    public function down_page($name = '下一页')
    {
        ...
        {
            return $this->_get_link($this->now_page + 1, $name, 'class="btn btn-inverse next"');
        }
        return '';
    }
    ...
    protected function show_2()
    {
        ...
        {
            $return = '';
            $return .= $this->up_page('<i class="fui-arrow-left"></i>');
            $return .= "<ul>";
            ...
            $return .= "</ul>";
            $return .= $this->down_page('<i class="fui-arrow-right"></i>');
            return $return;
        }
    }
