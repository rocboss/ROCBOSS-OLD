...
if (isset($_POST['host']))
{
	...
	mysql_query("
        ...
        mysql_query("CREATE TABLE `roc_device` (
                    `device_id` mediumint(8) unsigned NOT NULL,
                    `ios_token` char(100) NOT NULL,
                    `android_token` char(100) NOT NULL,
                    `user_id` mediumint(8) NOT NULL,
                    `last_used_device` int(1) NOT NULL
                    ) ENGINE=InnoDB DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT");
        
        #  ==================== APNS =======================
        
        mysql_query("CREATE TABLE `apns_device_history` (
        ...
        mysql_query("CREATE TABLE `apns_devices` (
                    `pid` int(9) unsigned NOT NULL auto_increment,
                    `clientid` varchar(64) NOT NULL,
                    `appname` varchar(255) NOT NULL,
                    `appversion` varchar(25) default NULL,
        ...
        mysql_query("CREATE TRIGGER `Archive` BEFORE UPDATE ON `apns_devices` FOR EACH ROW INSERT INTO `apns_device_history` VALUES (
	             NULL,
	             OLD.`clientid`,
	             OLD.`appname`,
	             OLD.`appversion`,
        ...
        mysql_query("CREATE TABLE `apns_messages` (
                    `pid` int(9) unsigned NOT NULL auto_increment,
                    `clientid` varchar(64) NOT NULL,
